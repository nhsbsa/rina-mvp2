!function (t, e) {
  ...
  return function () {
        ...
        7680: function (t, e, n) {
          ...
          (O || S || _ || d || h) && (y = function (t) {
            ...
            var I = h.groups,
              ...
              N = 0,
              T = C;
            if (j && (A = x(A, "y", ""), -1 === b(A, "g") && (A += "g"), T = w(C, d.lastIndex), d.lastIndex > 0 && (!d.multiline || d.multiline && "\n" !== g(C, d.lastIndex - 1)) && (P = "(?: " + P + ")", T = " " + T, N++), n = new RegExp("^(?:" + P + ")", A)), S && (n = new RegExp("^" + P + "$(?!\\s)", A)), O && (r = d.lastIndex), o = i(m, j ? n : d, T), j ? o ? (o.input = w(o.input, N), o[0] = w(o[0], N), o.index = d.lastIndex, d.lastIndex += o[0].length) : d.lastIndex = 0 : O && o && (d.lastIndex = d.global ? o.index + o[0].length : r), S && o && o.length > 1 && i(v, o[0], n, function () {
    ...
    return function () {
      ...
      function d() {
        for (var t; t = f.pop();) t._dirty && k(t);
      }
      function h(t, e, n) {
      ...
      function E(t, e, n, r, o) {
        ...
        if ("function" == typeof s) return function (t, e, n, r) {
          ...
          o && c && (!r || o._component) ? (T(o, s, 3, n, r), t = o.base) : (i && !a && (R(i), t = u = null), o = P(e.nodeName, s, n), t && !o.nextBase && (o.nextBase = t, u = null), T(o, s, 1, n, r), t = o.base, u && t !== u && (u._component = null, I(u, !1)));
          return t;
        }(t, e, n, r);
        ...
        if (!t._disable) {
          ...
          if (t.constructor.getDerivedStateFromProps && (l = a(a({}, l), t.constructor.getDerivedStateFromProps(s, l)), t.state = l), v && (t.props = p, t.state = d, t.context = h, 2 !== n && t.shouldComponentUpdate && !1 === t.shouldComponentUpdate(s, l, f) ? O = !0 : t.componentWillUpdate && t.componentWillUpdate(s, l, f), t.props = s, t.state = l, t.context = f), t.prevProps = t.prevState = t.prevContext = t.nextBase = null, t._dirty = !1, !O) {
            ...
            if ("function" == typeof A) {
              var N = m(i);
              (u = b) && u.constructor === A && N.key == u.__key ? T(u, N, 1, f, !1) : (E = u, t._component = u = P(A, N, f), u.nextBase = u.nextBase || y, u._parentComponent = t, T(u, N, 0, f, !1), k(u, 1, r, !0)), j = u.base;
      ...
      var K = function (t) {
        ...
        return o.isQueryAnOption = function (t, e) {
          ...
          var t,
            ...
            M = 0 !== j.length,
            L = j.length >= a,
            D = this.props.showNoOptionsFound && k && R && M && L,
            F = r + "__wrapper",
            V = r + "__status",
            ...
            Q = G && 0 === G.toLowerCase().indexOf(j.toLowerCase()) && T ? j + G.substr(j.length) : "",
            $ = i + "__assistiveHint",
            Y = {
